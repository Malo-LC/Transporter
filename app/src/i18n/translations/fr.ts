...
const frMessages: Translations = {
  ...
  home: {
    ...
    loginToDeezer: 'Se connecter à Deezer',
  },
  deezer: {
    authSuccess: 'Authentification Deezer réussie',
    callback: 'Authentification Deezer en cours, veuillez patienter...',
    chooseExportMethod: "Veuillez choisir une méthode d'exportation",
    connectedAs: (userId: string | undefined) => `Connecté à Deezer en tant que : ${userId}`,
    ...
    error: (error: string) => `Erreur de connexion à Deezer : ${error}`,
    export: 'Exporter',
  ...
  spotify: {
    ...
    connectedAs: (userId: string | undefined) => `Connecté à Spotify en tant que : ${userId}`,
  },
  login: {
    title: 'Se connecter',
  },
  ...
  'http-errors': {
    ...
    DEEZER_ACCESS_TOKEN_MISSING: "L'accès à Deezer est requis",
