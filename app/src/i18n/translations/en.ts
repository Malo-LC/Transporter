...
const enMessages: Translations = {
  ...
  home: {
    ...
    loginToDeezer: 'Log in to Deezer',
  },
  deezer: {
    authSuccess: 'Deezer authentication successful',
    callback: 'Deezer authentication in progress, please wait...',
    chooseExportMethod: 'Please choose an export method',
    connectedAs: (userId: string | undefined) => `Connected to Deezer as : ${userId}`,
    ...
    error: (error: string) => `Deezer connection error: ${error}`,
    export: 'Export',
  ...
  spotify: {
    ...
    connectedAs: (userId: string | undefined) => `Connected to Spotify as : ${userId}`,
  },
  login: {
  ...
  'http-errors': {
    ...
    DEEZER_ACCESS_TOKEN_MISSING: 'Deezer access token missing',
