...
import type { ListItemAction, ListItemProps } from '@lib/plume-admin-theme/list/ListProps';
import { Icon, IconButton } from '@mui/material';
import { ActionsContainer } from '../action/Actions';

import scss from './list.module.scss';

function ListItem({ className, onClick, actions = [], children }: Readonly<ListItemProps>) {
  return (
    <div
      aria-hidden="true"
