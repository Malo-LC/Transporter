...
import type { InputSelectProps } from '@lib/plume-admin-theme/form/FormInputProps';
import { SelectElement } from 'react-hook-form-mui';

import scss from './form-input.module.scss';

export default function InputSelect({ name, label, options, disabled, required, errorMessageMapping }: Readonly<InputSelectProps>) {
